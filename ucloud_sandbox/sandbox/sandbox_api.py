...
from ucloud_sandbox.sandbox.mcp import McpServer as BaseMcpServer
from ucloud_sandbox.sandbox.network import ALL_TRAFFIC
...
class SandboxNetworkOpts(TypedDict):
    ...
    Supports ${PORT} variable. Defaults to "${PORT}-sandboxid.cn-wlcb.sandbox.ucloudai.com".
