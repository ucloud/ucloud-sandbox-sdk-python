...
from ucloud_sandbox.sandbox._git.auth import strip_credentials, with_credentials
from ucloud_sandbox.sandbox._git.parse import derive_repo_dir_from_url
from ucloud_sandbox.sandbox._git.types import ClonePlan
